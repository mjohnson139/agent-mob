...
**`main` contains only:** `AGENTS.md`, `CLAUDE.md`, `team.yml`, `.gitignore`, and `docs/`. No project artifacts, no task directories, no QRSPI phase files ever exist on `main`.
...
2. Create files on `main` outside of `AGENTS.md`, `CLAUDE.md`, `team.yml`, `.gitignore`, `docs/`
